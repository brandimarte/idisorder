...
FFLAGS = -O3 -xHost #-traceback -g #-check all 
...
GPU_LIBS    = $(MAGMA_LIB) -L$(CUDA_DIR)/lib64 -lcublas -lcuda -lcudart -lstdc++
GPU_INCLUDE = -I$(CUDA_DIR)/include -I$(MAGMA_DIR)/include
GPU_DEFS    = -DFORTRAN -DMAGMA -DHAVE_CUBLAS

CXX = icpc
CXXFLAGS = -O3 -xHost -fno-exception #-g -traceback
...
#Hybrid_Interface.o:
#	$(CXX) -c ../Src/Hybrid_Interface.cpp $(CXXFLAGS) $(FPPFLAGS_GPU) $(GPU_INCLUDE)
#
