...
FFLAGS = -O2 -xHost -traceback -C -heap-arrays 1024 \
...
MKL              = /opt/intel/composer_xe_2013.5.198/mkl
INTEL_LIBS       = $(MKL)/lib/libmkl_intel_lp64.a \
                   $(MKL)/lib/libmkl_sequential.a \
                   $(MKL)/lib/libmkl_core.a
#                   $(MKL)/lib/libmkl_lapack95_lp64.a \
#                   $(MKL)/lib/libmkl_blas95_lp64.a
SCALAPACK_LIBS   = /opt/local/lib/libscalapack.a
MKL_LIBS         = $(INTEL_LIBS) $(SCALAPACK_LIBS) -lpthread -lm
...
FPPFLAGS = $(FPPFLAGS_MPI) $(FPPFLAGS_GPU)
...
LIBS = $(GPU_LIBS) $(MKL_LIBS) $(MPI_LIBS) $(COMP_LIBS)
