...
# --- Axis ranges ---
set xrange [ -2.000 : 2.000 ] noreverse nowriteback
#set xrange [ 0.000 : 1.80000 ] noreverse nowriteback
set yrange [ -0.50 : 0.50 ] noreverse nowriteback
set zrange [ -2.0e-04 : 2.00e-04 ] noreverse nowriteback
set cbrange [ -7.0e-05 : 7.0e-05 ]
...
set zlabel "I (A)" 
set zlabel  offset character -2, 0, 0 font "Arial,45" textcolor lt -1 norotate
...
set multiplot layout 2, 2
#fileEl='ExVxIel.tot'
#fileTot='ExVxItot.tot'
#fileSy='ExVxIsy.tot'
#fileAsy='ExVxIasy.tot'
#fileEl='ExVxIel.red1'
#fileTot='ExVxItot.red1'
#fileSy='ExVxIsy.red1'
#fileAsy='ExVxIasy.red1'
#fileEl='ExVxIel.red2'
#fileTot='ExVxItot.red2'
#fileSy='ExVxIsy.red2'
#fileAsy='ExVxIasy.red2'
fileEl='ExVxIel.red3'
fileTot='ExVxItot.red3'
fileSy='ExVxIsy.red3'
fileAsy='ExVxIasy.red3'
# [1,1]
#set title "Elastic\n{/*0.6E_F  = -4.3354 eV}\n{/*0.6E_{ph} =  0.4544 eV}"
set title titleEl
...
#splot fileTot
# [2,1]
set zrange [ -1.0e-06 : 1.0e-06 ] noreverse nowriteback
set cbrange [ -1.0e-07 : 1.0e-07 ]
set ztics 5e-07
#set title "Inelastic (symmetric part)\n{/*0.6E_F  = -4.3354 eV}\n{/*0.6E_{ph} =  0.4544 eV}"
set title titleIsy
