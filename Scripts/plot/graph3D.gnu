...
# --- Axis ranges ---
set xrange [ -1.000 : 1.000 ] noreverse nowriteback
#set xrange [ 0.000 : 1.80000 ] noreverse nowriteback
set yrange [ -0.50 : 0.50 ] noreverse nowriteback
set zrange [ -1.20e-04 : 1.20e-04 ] noreverse nowriteback
...
#splot fileTot
# [2,1]
set zrange [ -3.0e-07 : 3.0e-07 ] noreverse nowriteback
set cbrange [ -3.0e-8 : 3.0e-8 ]
#set title "Inelastic (symmetric part)\n{/*0.6E_F  = -4.3354 eV}\n{/*0.6E_{ph} =  0.4544 eV}"
set title titleIsy
