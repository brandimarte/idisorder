...
set zrange [ -0.0 : 6.00 ] noreverse nowriteback
set cbrange [ -5.0 : 5.0 ]

# --- Tics ---
set xtics font "Arial,35" offset 0,-1.5
...
set xlabel "E - E_F (eV)" 
set xlabel  offset character 0, -4, 0 font "Arial,45" textcolor lt -1 norotate
#set ylabel "V (V)"
...
#set title "Elastic\n{/*0.6E_F  = -4.3354 eV}\n{/*0.6E_{ph} =  0.4544 eV}"
set title titleEl
splot fileEl with lines lt 2 lw 5

set view 70, 20, 1, 1
set zrange [ -2.0 : 6.00 ] noreverse nowriteback
...
# [2,1]
set zrange [ -0.03 : 0.06 ] noreverse nowriteback
set cbrange [ -6.0e-03 : 6.0e-03 ]
set ztics 0.02
set format z "%.0e"
#set title "Inelastic (symmetric part)\n{/*0.6E_F  = -4.3354 eV}\n{/*0.6E_{ph} =  0.4544 eV}"
set title titleIsy
